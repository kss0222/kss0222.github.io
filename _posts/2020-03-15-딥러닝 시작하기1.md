...
2. [파이썬으로 배우는 딥러닝 교과서 전체 예제 소스](http://www.hanbit.co.kr/lib/examFileDown.php?hed_idx=4496).
   ...
   <a href="4장.ipynb" download>변수와 자료형</a> <a href="5장.ipynb" download>반복문</a>
   <a href="6장.ipynb" download>함수 기초</a> 
   <a href="7장.ipynb" download>NumPy</a> 
   <a href="8장.ipynb" download>Pandas</a> 
   <a href="11장.ipynb" download>데이터 시각화, matplotlib</a> 
   <a href="15장.ipynb" download>OpenCV 이용 및 이미지 데이터 전처리</a> 
